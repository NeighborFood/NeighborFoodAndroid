...
public class SignUpActivityTest {
    ...
    private final AuthenticatorUser fakeUser = new AuthenticatorUser("0", "FakeEmail@gmail.com", "Firstname", "Lastname", "") {
    };

    @Rule
    public final ActivityScenarioRule<SignUpActivity> testRule = new ActivityScenarioRule<>(SignUpActivity.class);
    ...
    @Before
    public void logOut() {
        testRule.getScenario().onActivity(activity -> activity.updateUI(null));
...
/**
    ...
    public void updateUIWithFakeLoggedInUser() {
        testRule.getScenario().onActivity(activity -> activity.updateUI(fakeUser));
    }
